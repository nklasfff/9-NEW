...
window.TRANSLATIONS = {
  ...
  da: {
    ...
    journal_share: 'Del',
    journal_delete: 'Slet',
    journal_deep_title: 'Dine Refleksioner',
    journal_deep_sub: 'Fang hvad denne fase vækker i dig',
    journal_time_title: 'Rejsenoter',
    journal_time_sub: 'Hvad afslørede denne rejse?',
    journal_rel_title: 'Om Forbindelser',
    journal_rel_sub: 'Hvad ser du i rummet mellem jer?',
    journal_win_title: 'Vinduesnoter',
    journal_win_sub: 'Hvad åbnede sig i dette øjeblik?',
    ...
    tj_now_label: 'NU',
    tj_result_title_default: 'Ild · Forvandlingen',
    tj_result_meta_default: 'Fase 3 · 14–21 år · Sommer',
    tj_el_default: 'Ild',
    tj_season_default: 'Sommer · Ild',
    tj_phase_default: 'Fase 3 · Forvandlingen',
    tj_organ_default: 'Hjerte · Ild',
    tj_deep_default: 'Dyk ned i 15. juni 2000',
    ...
    db_body_causes: '<strong style="font-weight:400;color:var(--text-secondary)">Årsager:</strong> Overgangsalder, uforløst sorg, stress der komprimerer vejrtrækningen.',
    ...
    db_advice_btn: '5 råd til dig i Fase 7',
    db_advice_1: '<span>01</span> Træk vejret bevidst hver morgen — 10 runder af 4-2-8. Lungerne er metallets organ, og bevidst udånding aktiverer det parasympatiske nervesystem og sænker kortisol målbart inden for to uger.',
    db_advice_2: '<span>02</span> Ryd fysisk op — én skuffe, ét skab, én forpligtelse ad gangen. Metal handler om at adskille kerne fra skal. Hver ting du fjerner skaber plads til klarhed og ro i nervesystemet.',
    db_advice_3: '<span>03</span> Gå 20 minutter i frisk luft dagligt, helst i køligt vejr. Lungerne genopbygges af kold, ren luft. Undgå at tale undervejs — lad lungerne arbejde uforstyrret og mærk stilheden som næring.',
    db_advice_4: '<span>04</span> Tillad vemodet når det kommer — undertrykket sorg sætter sig i lungerne som spænding og kortåndethed. Giv det fem minutter med lukkede øjne. Tårerne er metallets renselse og gør dig lettere bagefter.',
    db_advice_5: '<span>05</span> Øv dig i ét bevidst nej om ugen. Skelneevne uden handling er kun teori. Hvert nej til det uvæsentlige er et ja til det der virkelig betyder noget for dig i denne fase af dit liv.',
  ...
  en: {
    ...
    journal_deep_title: 'Your Reflections',
    journal_deep_sub: 'Capture what this phase awakens in you',
    journal_time_title: 'Travel Notes',
    journal_time_sub: 'What did this journey reveal?',
    journal_rel_title: 'Connection Notes',
    journal_rel_sub: 'What do you see in the space between you?',
    journal_win_title: 'Window Notes',
    journal_win_sub: 'What opened in this moment?',
    ...
    tj_now_label: 'NOW',
    tj_result_title_default: 'Fire · The Flame',
    tj_result_meta_default: 'Phase 3 · 14–21 years · Summer',
    tj_el_default: 'Fire',
    tj_season_default: 'Summer · Fire',
    tj_phase_default: 'Phase 3 · The Flame',
    tj_organ_default: 'Heart · Fire',
    tj_deep_default: 'Dive into 15 June 2000',
    ...
    db_body_causes: '<strong style="font-weight:400;color:var(--text-secondary)">Causes:</strong> Perimenopause, unresolved grief, stress that constricts the breath.',

    db_themes_label: 'Themes in Phase 7',
    db_theme_menopause: 'Perimenopause',
    ...
    db_theme_breath: 'Breath as practice',
    ...
    db_advice_btn: '5 tips for Phase 7',
    db_advice_1: '<span>01</span> Breathe consciously every morning — 10 rounds of 4-2-8. The lungs are metal\'s organ, and deliberate exhalation activates the parasympathetic nervous system, measurably lowering cortisol within two weeks.',
    db_advice_2: '<span>02</span> Declutter physically — one drawer, one cupboard, one obligation at a time. Metal is about separating the core from the shell. Every thing you remove creates space for clarity and calm in the nervous system.',
    db_advice_3: '<span>03</span> Walk for 20 minutes in fresh air daily, ideally in cool weather. The lungs regenerate through cold, clean air. Avoid talking along the way — let the lungs work undisturbed and feel the silence as nourishment.',
    db_advice_4: '<span>04</span> Allow the wistfulness when it comes — suppressed grief settles in the lungs as tension and shortness of breath. Give it five minutes with your eyes closed. Tears are metal\'s cleansing and leave you lighter.',
    db_advice_5: '<span>05</span> Practice one conscious no per week. Discernment without action is just theory. Every no to the inessential is a yes to what truly matters in this phase of your life.',
